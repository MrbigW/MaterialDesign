 ...
 */
public class StaggeredRecyclerAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View item = LayoutInflater.from(parent.getContext()).inflate(R.layout.staggered_item_layout, parent, false);
